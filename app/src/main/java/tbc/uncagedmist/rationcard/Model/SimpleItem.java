...
public class SimpleItem extends DrawerItem<SimpleItem.SimpleViewHolder> {
    ...
    @Override
    public void bindViewHolder(SimpleViewHolder holder) {
    ...
    static class SimpleViewHolder extends DrawerAdapter.DrawerViewHolder    {
